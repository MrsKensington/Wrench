 ...
 *
 * i.e. the `WrenchServer` manages a bunch of `WrenchConnection`s
 */
class WrenchConnection extends Configurable
{
    /**
    ...
    public function handshake($data)
    {
        try {
            ...
            $this->manager->getServer()->notify(
                WrenchServer::EVENT_HANDSHAKE_SUCCESSFUL,
                array($this)
            );
