 ...
 */
class WrenchServer extends Configurable
{
    /**#@+
     * Events
     *
     ...
     * WrenchApplications
     *
     * @var array<string => WrenchApplication>
     */
     ...
     * Adds a listener
     *
     * Provide an event (see the WrenchServer::EVENT_* constants) and a callback
     ...
     * @return WrenchApplication The application object.
     */
